...
//"curl 'http://omnichannel.chat.comunix.tech:81/omnichannel/insert_chat_call.php?number=$clid&channel=$servico_now_number&login=$agente&uniqueid=$uniqueid&cti=$cti'"
  ...
  //sendUPD($ip,"0",9999,$uniq);
    $cmd="curl 'https://omni.brbservicos.com.br:1443/insert_chat_call.php?number=$clid&uniqueid=$uniqueid&login=$agente&link=1&cti=$cti'";
    echo $cmd."\n";
     system("curl 'https://omni.brbservicos.com.br:1443/insert_chat_call.php?number=$clid&uniqueid=$uniqueid&login=$agente&link=1&cti=$cti'");
  ...
  if ($status==9){
 // sendUPD($ip,"0",9999,"0#");
         $cmd="curl 'https://omni.brbservicos.com.br:1443/finish_chat_call.php?uniqueid=$old_uniqueid'";
          echo $cmd."\n";
         system("curl 'https://omni.brbservicos.com.br:1443/finish_chat_call.php?uniqueid=$old_uniqueid'");
         $old_uniqueid="";
  }
...
//SIP PROXY
$pacote_sip="echo '$cd_equipe,$cd_unidade,$servidor,$id_avento,$cd_camp,$cti,' > /dev/shm/$agente";
system($pacote_sip);
//WEbSOCKET
$pacote_web="echo '$agente,$status,$pause,$tm_status,$clid,$cti,$ms,$tm_login,$first_login,$nm_queue_now,$ip,$delay,$clid2,$servico_now,$uniqueid,' > /dev/shm/comunix/$agente";
system($pacote_web);
//CDR
...
if ((time()-$tm_clid_busy)<=4){
 ...
 return "6,$clid,$servico,$uniqueid,$clid2,$cti";
