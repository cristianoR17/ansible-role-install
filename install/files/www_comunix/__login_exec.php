...
if (($ok==1)){
     ...
     if ($autoanswer=="")
      ...
      $a='"login":{"user":"'.$agent_name.'","port_http_keep":"'.$port_keep.'","autoanswer":"'.$autoanswer.'","ramal":"'.$ramal.'","pauses":{"72":"'.$p72.'","73":"'.$p73.'","74":"'.$p74.'","75":"'.$p75.'","76":"'.$p76.'","77":"'.$p77.'","78":"'.$p78.'","79":"'.$p79.'","80":"'.$p80.'","81":"'.$p81.'","82":"'.$p82.'","83":"'.$p83.'","84":"'.$p84.'"},'.'"transfer":{'.$str.'}}';
